...
public class MyLocalDevice {
    ...
    public static RemoteUtils remoteUtils;
    ...
    public synchronized static LocalDevice getInstance(String prot){
        if(localDevice==null){
            synchronized (MyLocalDevice.class){
                if(localDevice==null){
                    new MyLocalDevice(prot);
                }
            }
        }
        return localDevice;
    ...
    private MyLocalDevice(){}

    private MyLocalDevice(String prot){
...
//    }
    ...
    public RemoteUtils getmRemoteUtils() {
        return remoteUtils;
    }
